<nav id="mainNav" class="navbar fixed-top navbar-default navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav form-inline my-2 my-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/sahal/index.php">Home</a>
      </li>
          
      <li class="nav-item">
        <a class="nav-link" href="#">Donated</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href='update.php?blooddonerId=<?php echo $name;?>'>Update</a>
      </li>
      <li class="nav-item">
